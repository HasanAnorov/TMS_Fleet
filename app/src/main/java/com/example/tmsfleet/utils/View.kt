...
fun ImageView.loadImage(url: String) = Picasso.get().load(url).placeholder(R.drawable.person).error(R.drawable.person).into(this)
...
//this is test line for git problem
//this is test line for git problem
//this is test line for git problem
